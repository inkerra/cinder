...
class CreateDeserializer(wsgi.MetadataXMLDeserializer):
    ...
    def _extract_volume_permission(self, node):
        ...
        attributes = ['id', 'volume_id', 'type', 'user_or_group_id',
                      'access_permission']
...
class VolumeACLController(wsgi.Controller):
    ...
    def create(self, req, body):
        ...
        user_or_group_id = volume_permission['user_or_group_id']
        ...
        try:
            new_volume_permission = \
                self.volume_acl_api.create(context, volume_id, permission_type,
                                           user_or_group_id, access_permission)
